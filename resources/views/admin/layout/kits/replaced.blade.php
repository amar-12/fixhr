...
@section('title', 'Kit Replacements')
...
@section('content')
        ...
        <div class="row">
            <div class="col-md-4">
                <ol class="breadcrumb breadcrumb-arrow m-0 p-0" style="background:none;">
                    ...
                    <li class="active"><span><b>Kit Replacements</b></span></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-0 d-flex justify-content-between align-items-center">
                    <h4 class="card-title">Kit Replacement Records</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div id="filterContainer" class="row mt-3" style="display:none;">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" id="dateRange" data-date-filter
                                placeholder="Select Date">
                        </div>
                    </div>

                    <!-- TABLE -->
                    <table class="table table-hover table-vcenter text-wrap border-bottom mt-3" id="kit-replaced-table">
                        <thead>
                            <tr>
    ...
    <script>
        function toggleFilters() {
            let box = document.getElementById("filterContainer");
            box.style.display = box.style.display === "none" ? "flex" : "none";
        }

        $(document).ready(function() {
            datatable({
                tableId: "kit-replaced-table",
