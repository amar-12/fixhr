...
@section('title', 'Kit Lost Records')
@section('header')
...
@section('content')
        ...
        <div class="row">
            <div class="col-md-4">
                <ol class="breadcrumb breadcrumb-arrow m-0 p-0" style="background:none;">
                    ...
                    <li class="active"><span><b>Kit Lost Items</b></span></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-0 d-flex justify-content-between align-items-center">
                    <h4 class="card-title">Lost Kit Records</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <!-- TABLE -->
                    <!-- TABLE -->
                    <table class="table table-hover table-vcenter text-wrap border-bottom mt-3" id="kit-lost-table">
                        <thead>
                            <tr>
    ...
    <script>
        $(document).ready(function() {
            datatable({
                tableId: "kit-lost-table",
                url: "{{ route('kitlost.index') }}",
