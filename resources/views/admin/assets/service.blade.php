...
@section('content')
        ...
        <div class="row">
            <div class="col-md-4">
                <ol class="breadcrumb breadcrumb-arrow m-0 p-0" style="background: none;">
                    ...
                    <li class="active"><span><b>Service Assets</b></span></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-0">
                    <h4 class="card-title">Service Assets</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-1">
    ...
    <!-- Single Asset Status Update Modal -->
    <div class="modal fade" id="updateStatusModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="updateStatusForm" method="POST" action="{{ route('assets.update-status') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="alert alert-info">
                            <strong>Asset:</strong> <span id="statusAssetTag"></span>
                        </div>
                        ...
                        {{-- Remark Field --}}
                        <div class="mb-3">
                            <label for="status_remark" class="form-label">Remark</label>
                            <textarea name="remark" id="status_remark" class="form-control" rows="2" placeholder="Enter any remark..."></textarea>
                        </div>
                    </div>
...
@section('script')
    ...
    <script>
        $(document).on('click', '.update-status-btn', function() {
            ...
            // Pehle purane hidden inputs ko hatao
            $('#updateStatusForm input[name="asset_id"], #updateStatusForm input[name="asset_tag"]').remove();

            // Naye inputs add karo
            $('#updateStatusForm').append(
                `<input type="hidden" name="asset_id" value="${assetId}">` +
                `<input type="hidden" name="asset_tag" value="${assetTag}">`
            );

            // Modal me asset tag show karo
            $('#statusAssetTag').text(assetTag);
