...
<div>
    <div class="mt-3">
        <ol class="breadcrumb breadcrumb-arrow m-0 p-0" style="background: none;">
            ...
            <li class="active"><span><b>Asset Replacement Report</b></span></li>
        </ol>
    </div>
                ...
                <div class="col-md-10">
                    ...
                    <div class="ef-panel">
                        ...
                        <div class="ef-panel-header">
                            <span class="ef-panel-title">Asset Replacement Report Filters</span>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#saveUptBtn').on('click', function (e) {
                ...
                var form = $('<form>', {
                    action: "{{ route('assets.report.export.replace') }}",
                    method: "POST"
                });
