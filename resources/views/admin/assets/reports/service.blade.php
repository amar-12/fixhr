...
<div>
    <div class="mt-3">
        <ol class="breadcrumb breadcrumb-arrow m-0 p-0" style="background: none;">
            ...
            <li><a href="{{ url('/admin/report/assets-report') }}">Assets Management</a></li>
            <li class="active"><span><b>Asset Service Report</b></span></li>
        </ol>
    </div>
                ...
                <div class="col-md-10">
                    ...
                    <div class="ef-panel">
                        ...
                        <div class="ef-panel-header">
                            <span class="ef-panel-title">Asset Service Report Filters</span>
                        </div>
                        ...
                        <div class="row gx-3 gy-3">
                            ...
                            {{-- Employee --}}
                            <div class="col-md-6">
                                <label class="ef-field-label">Employee</label>
                                <select name="employee" class="ef-control select2">
                                    <option value="">All</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="department" class="ef-control select2">
                                    <option value="">All</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="designation" class="ef-control select2">
                                    <option value="">All</option>
                                    @foreach ($designations as $des)
                                        <option value="{{ $des->dg_id }}">{{ $des->dg_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="branch" class="ef-control select2">
                                    <option value="">All</option>
                            ...
                            {{-- Service Type --}}
                            <div class="col-md-6">
                                <label class="ef-field-label">Service Type</label>
                                <select name="serviceType" class="ef-control select2">
                                    <option value="">All</option>
                            ...
                            {{-- Service Location --}}
                            <div class="col-md-6">
                                <label class="ef-field-label">Service Location</label>
                                <select name="serviceLocation" class="ef-control select2">
                                    <option value="">All</option>
                                    @foreach ($serviceLocations as $location)
                                        <option value="{{ $location->br_id }}">{{ $location->br_name }}</option>
                                    @endforeach
                                </select>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#saveUptBtn').on('click', function (e) {
                ...
                var form = $('<form>', {
                    action: "{{ route('assets.report.export.service') }}",
                    method: "POST"
                });
                ...
                // Employee / org filters
                form.append('<input type="hidden" name="employee"        value="' + $('select[name="employee"]').val()        + '">');
                form.append('<input type="hidden" name="designation"     value="' + $('select[name="designation"]').val()     + '">');
                form.append('<input type="hidden" name="department"      value="' + $('select[name="department"]').val()      + '">');
                form.append('<input type="hidden" name="branch"          value="' + $('select[name="branch"]').val()          + '">');

                // Service filters
                form.append('<input type="hidden" name="serviceType"     value="' + $('select[name="serviceType"]').val()     + '">');
                form.append('<input type="hidden" name="serviceLocation" value="' + $('select[name="serviceLocation"]').val() + '">');
