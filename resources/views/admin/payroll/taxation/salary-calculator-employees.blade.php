                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a class="btn btn-sm btn-outline-primary"
                                           href="{{ route('taxation.salary-calculator.addEdit', \Illuminate\Support\Facades\Crypt::encrypt($emp->emp_id)) }}">
                    ...
                    @if($previewEmployee)
                        <div class="quick-step">
                            ...
                            <a class="btn btn-primary btn-sm mt-2"
                               href="{{ route('taxation.salary-calculator.addEdit', \Illuminate\Support\Facades\Crypt::encrypt($previewEmployee->emp_id)) }}">
