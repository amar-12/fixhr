    ...
    <div>
        <div class=" p-0 pb-4">
            <ol class="breadcrumb breadcrumb-arrow m-0 p-0" style="background: none;">
                ...
                <li class="active"><span><b>Loan/Advance Requests</b></span></li>
            </ol>
        </div>
            ...
            <div class="col-xl-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header border-0">
                        <h4 class="card-title">Loan/Advance Requests </h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-1">
                                ...
                                <div id="filterContainer" style="display: none; margin-bottom: 21px;">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            ...
                                            <select id="loan_branchFilter" data-filter
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <select id="loan_departmentFilter" data-filter
                                                class="form-select search-txt filter_border">
                                                <option value="">All</option>
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <select id="loan_designationFilter" data-filter
                                                class="form-select search-txt filter_border">
                                                <option value="">All</option>
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input type="date" id="toDate" value="{{ now()->format('Y-m-d') }}"
                                                class="form-control filter_border" data-date-filter="to-date" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        if ($.fn.DataTable.isDataTable('#gate-pass-table-dynamic')) {
            $('#gate-pass-table-dynamic').DataTable().clear().destroy();
        }

        // ✅ Initialize DataTable safely
        datatable({
            tableId: "gate-pass-table-dynamic",
            url: "{{ route('requests.loan-requests') }}",
    ...
    // ✅ SweetAlert for file upload messages
