...
<div class="p-0 mt-3">
    ...
    <div class="page-header d-md-flex d-block">
        ...
        <div class="page-rightheader ms-md-auto">
            <button class="btn btn-outline-primary" id="addadhocBtn">Add Adhoc Payment/Deduction</button>
        </div>
    </div>
        ...
        <div class="col-xl-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-header border-0">
                    <h4 class="card-title">Adhoc Payment/Deduction</h4>
                </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="employeeSalaryImportModalTitle">Import Adhoc Deductions</h5>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="adhocSearchForm">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="adhocTransactionModalLabel">Add Adhoc Payments/Deductions</h5>
...
<script>
    $('#adhocSearchForm').on('submit', function (e) {
        ...
        const employeeId = $('#employee_id').val(); // dynamically added on employee select
        const departmentId = $('#department_id').val();
        const payrollPeriodId = $('#payroll_period_id').val();
        ...
        $.ajax({
            ...
            success: function (res) {
                // if (!res.status) {
                //     alert(res.message); // Salary already processed
                //     return;
                // }
                ...
                // 🔹 Step 2: Build the redirect URL (same as your existing code)
                let url = "{{ route('adhoc.form.view') }}";
                ...
                // 🔹 Step 3: Redirect only if salary not processed
