...
<body>
    ...
    <div class="letter-container">
        ...
        <div class="text-center mb-4" style="margin-top:80px !important;">
            <h5 class="letter-title">EXPERIENCE CERTIFICATE</h5>
        </div>
        ...
        <div>
            ...
            <p class="text-justify">
                ...
                as a <strong>{{ $exit->employee->fh_designation->dg_name ?? '' }}</strong>
                in the <strong>{{ $exit->employee->fh_department->d_name ?? '' }}</strong> department
            ...
            <p class="text-justify">
                During your tenure, you have performed your duties sincerely and to the best of your abilities.
                You were punctual, disciplined, and maintained professional conduct throughout your service period.
            </p>
