...
<body>
    ...
    <div class="letter-container">
        ...
        <div class="text-center mb-4" style="margin-top:80px !important;">
            <h5 class="letter-title">SERVICE CERTIFICATE</h5>
        </div>
        ...
        <div>
            ...
            <p class="text-justify">
                During this period, {{ $exit->employee->fh_employee_title->m_name }}
                {{ $exit->employee->emp_full_name }}
                rendered professional services diligently and contributed to the growth and success of the organization.
            </p>

            <p class="text-justify">
                This certificate is issued upon request of the employee and reflects the duration and nature of their
                service.
            </p>
        </div>
