...
<body>
    ...
    <div class="letter-container">
        ...
        <div class="text-center mb-4" style="margin-top:80px !important;">
            <h4 class="letter-title">NO DUES CERTIFICATE</h4>
        </div>
        ...
        <div>
            ...
            <p class="text-justify">
                ...
                has cleared all dues, obligations, and responsibilities towards
                <strong>{{ $exit->employee->fh_business->b_name }}</strong> as of
                <strong>{{ \Carbon\Carbon::parse($exit->er_last_working_day)->format('d F Y') }}</strong>.
            </p>

            <p class="text-justify">
                We confirm that the employee has returned all company assets, completed handovers, and no pending
                financial or administrative dues remain.
            </p>

            <p class="text-justify">
                This certificate is issued upon the request of the employee and serves as proof of clearance of all
                dues.
            </p>
        </div>
