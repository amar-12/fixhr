    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-12 col-lg-12">
            ...
            <div class="card outer-border position-relative example-4">
                <!--<span id="claimStatusBadge" class="badge badge-claim position-absolute" style="background-color: {{ $color }}">-->
                <!--    <i id="claimStatusIcon" class="{{ $icon }}">&nbsp;</i>-->
                <!--    <span id="claimStatusName">{{ $singleClaim->fh_claim_status->m_name ?? 'N/A' }}</span>-->
                <!--</span>-->
                                    ...
                                    <div class="panel-body tabs-menu-body">
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tabSelfExpSummary">
                                                <!-- ROW -->
                                                @if($claimData->where('fh_claim_status.m_id', 140)->count() > 0)
                                                <div>
                                                    <input type="checkbox" id="selectAllTravelIds"> Select All
                                                </div>
                                                @endif
                                                <div class="row">
                                                            ...
                                                            <div class="accordion" id="accordion-{{ $index }}">
                                                                <div class="acc-card">
                                                                    ...
                                                                    <div class="acc-header d-flex align-items-center" id="heading-{{ $index }}">
                                                                        <div class="checkbox-placeholder me-2" style="width: 20px;">
                                                                        <input type="text" value="{{$claim->fh_claim_status->m_id}}" > 
                                                                            @if($claim->fh_claim_status->m_id == 140)
                                                                                <input type="checkbox" 
                                                                                       name="selected_travel_ids[]" 
                                                                                       value="{{ $plan->fh_tada_claim->tc_id ?? '' }}"
                                                                                       class="travel-id-checkbox">
                                                                            @endif
                                                                        </div>
                                                                        <h5 class="mb-0 flex-grow-1">
                                                                            <a class="d-flex justify-content-between align-items-center w-100" 
                                                                    ...
                                                                    <div id="collapse-{{ $index }}" class="collapse" aria-labelledby="heading-{{ $index }}" data-parent="#accordion-{{ $index }}">
                                                                        <div class="acc-body">
                                                                                                ...
                                                                                                <table class="table table-bordered table-hover text-nowrap">
                                                                                                    <thead>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            @if($claimApprovalData && !$displayDeductionHandler)
                                                                            ...
                                                                            @if($claimApprovalData && $actionRoute !== 'claim-request.request.show' && !$displayDeductionHandler)
                                                                                            ...
                                                                                            <form class="individualApprovalForm" id="approvalForm-{{ $claim->tc_id }}">
                                                                                                ...
                                                                                                <div class="d-flex justify-content-end mt-3">
                                                                                                    <button type="button" 
                                                                                                            ...
                                                                                                            data-is_last_approval="{{ $claimApprovalData->pa_last }}"
                                                                            ...
                                                                            <div class="col-xl-12 col-md-12 col-lg-6">
                                                                                @if(!($approvalData && $actionRoute !== 'claim-request.request.show' && !$displayDeductionHandler && $claim->fh_claim_status->m_id == 140))
                                                                            ...
                                                                            @if($displayDeductionHandler && $actionRoute == 'claim-request.request.show')
                                                                                <div class="employee-acceptance mt-4">
                                                                                    <div class="card">
                                                                                        <div class="card-header">
                                                                                            <h3 class="card-title">Accept Or Decline Deductions</h3>
                                                                                        </div>
                                                                                        <div class="card-body">
                                                                ...
                                                                <div class="card-footer mt-3">
                                                                    <div class="row">
                                                                        <div class="col-md-12 col-lg-12 d-flex justify-content-end">
                                                                            @php
                                                                                $firstPendingClaim = $claimData->where('fh_claim_status.m_id', 140)->first();
                                                                                if($firstPendingClaim) {
                                                                            ...
                                                                            @if(isset($approvalData) && $approvalData)
                                                                                <input type="hidden" name="claim_ids" value="{{ $claimData->where('fh_claim_status.m_id', 156)->pluck('tc_id')->implode(',') }}">
                                                                                ...
                                                                                <button type="button"
                                                                                    ...
                                                                                    data-emp_d_id="{{ optional($firstPendingClaim->fh_employee)->emp_d_id }}"
                                                                            ...
                                                                            <span
                                                                                class="font-weight-semibold fs-16 ms-3"><small
                                                                                    class="text-muted"><i
                                                                                        ...
                                                                                        <span
                                                                                            class="badge badge-md badge-primary-light ms-1"
                                                                                            >{{json_decode($expense->te_additional_info, true)['lodging']['totalDays']}} days</span></small></span>
                                                                                            @endif
                                                                        </li>
                                                                    </ul>
                                                                </div>
...
@section('script')
    ...
    <script>
        ...
        /*$(document).ready(function() {
            // Handle Approve/Reject All buttons
            $(document).on('click', '.actionBtnAll', function() {
                var button = $(this);
                var isApprove = button.data('approval_type') == 1;
                ...
                // Get all claim IDs from the hidden input
                var claimIds = $('input[name="claim_ids"]').val().split(',');
                ...
                var postData = {
                    ...
                    message: message,
                    _token: '{{ csrf_token() }}',
                    approval_status: button.data('approval_status'),
                    approval_type: button.data('approval_type'),
                    approval_action_type: button.data('approval_action_type'),
                    approval_sequence: button.data('approval_sequence'),
                    module_id: button.data('module_id'),
                    is_last_approval: button.data('is_last_approval'),
                    emp_d_id: button.data('emp_d_id'),
                    POST_TYPE: 'CLAIM_REQUEST_APPROVAL'
                };
        
                // For approval - prepare deductions if needed
                if (isApprove) {
                    var deductions = {};
                    var payableAmounts = {};
                    var isValid = true;
                    ...
                    $('.deduction-input').each(function() {
                        var $input = $(this);
                        var payableAmount = parseFloat($input.data('payableamount'));
                    ...
                    postData.deduction_info = deductions;
                    postData.payable_amount = payableAmounts;
                }
        
                // Show loading state
                $("#gloabal-overlay").show();
                button.prop('disabled', true).append('<i class="fa fa-spinner fa-spin ml-2"></i>');
        ...
        /*$(document).ready(function() {
            // Handle both bulk and individual actions
            $(document).on('click', '.bulkActionBtn, .individualActionBtn', function() {
                const button = $(this);
                const isBulkAction = button.hasClass('bulkActionBtn');
                const isApprove = button.data('approval_type') == 1;
                const action = isApprove ? 'approve' : 'reject';
                
                // Get appropriate message
                const message = isBulkAction 
                    ? $('#bulkActionMessage').val() 
                    : button.closest('.individualApprovalForm').find('.individual-message').val();
                ...
                let claimIds = [];
                if (isBulkAction) {
                    claimIds = $('input[name="claim_ids"]').val().split(',');
                } else {
                    claimIds = [button.data('tc_id')];
                }
                ...
                if (isApprove) {
                    ...
                    $('.deduction-input').each(function() {
                        const $input = $(this);
                        const payableAmount = parseFloat($input.data('payableamount'));
                ...
                // Determine endpoint
                const endpoint = isBulkAction 
                    ? '{{ route("claim-group.bulk.approved") }}' 
        ...
        $(document).on('click', '.individualActionBtn', function() {
            ...
            $clickedBtn.prop('disabled', true).html('<i class="fas fa-spinner fa-spin"></i> Processing');
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $clickedBtn.prop('disabled', true)
                            .html(`<i class="fas fa-spinner fa-spin me-1"></i> Processing ${selectedClaims.length} Claims...`);
