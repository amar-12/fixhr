...
@section('content')
        ...
        <div class="row">
            <div class="col-md-4">
                <ol class="breadcrumb breadcrumb-arrow m-0 p-0" style="background: none;">
                    ...
                    <li class="active"><span><b>Settlement</b></span></li>
                </ol>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="hidden" value="settlement">
    ...
    <!-- Settlement Modal -->
    <div class="modal fade" id="settlementModal" tabindex="-1" aria-labelledby="settlementModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow-lg">

                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title fw-bold" id="settlementModalLabel">Update Settlement</h5>
                ...
                <div class="modal-body">
                    <form id="settlementForm">
                        <input type="hidden" id="settlement_id" name="id">

                        <div class="row mb-3">
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Employee Name</label>
                                <div class="form-control-plaintext" id="emp_name"></div>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Settlement Amount</label>
                                <div class="form-control-plaintext text-danger" id="settlement_amount"></div>
                            </div>
                            <div class="col-md-4">
                                <label for="final_amount" class="form-label fw-semibold">
                                    Final Settlement Amount <span class="text-danger">*</span>
                                </label>
                                <input type="number" class="form-control" id="final_amount" name="final_amount"
                                    placeholder="Enter final settlement amount" required>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" form="settlementForm" class="btn btn-primary">Update</button>
                </div>
            </div>
        </div>
    </div>
...
@section('script')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            settlementModal.addEventListener('show.bs.modal', function(event) {
                let button = event.relatedTarget; // जिस बटन से modal खुला

                // data-* attributes से values निकालो
                let trId = button.getAttribute('data-id');
                let emp = button.getAttribute('data-emp');
                let amount = button.getAttribute('data-amount');

                // modal fields में भरो
                document.getElementById('settlement_id').value = trId;
                document.getElementById('emp_name').textContent = emp;
                document.getElementById('settlement_amount').textContent = amount;
            });
        });
    </script>
