    ...
    <div>
        <div class=" p-0 pb-4">
            <ol class="breadcrumb breadcrumb-arrow m-0 p-0" style="background: none;">
                ...
                <li class="active"><span><b>Leave Balance Report</b></span></li>
            </ol>
        </div>
        <!-- END ROW -->
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white" style="padding-bottom:770px;">
                <div class="container-fluid">
                    <span class="navbar-brand fw-bold me-5">
                        <span class="h3">Leave Balance</span>
                    </span>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form action="{{ route('leave.balance.report.details') }}" method="POST" class="d-flex mx-5 align-items-center">
                            @csrf
                            ...
                            <button type="submit" class="btn-sm btn-outline-success mt-4">Export</button>
                        </form>
