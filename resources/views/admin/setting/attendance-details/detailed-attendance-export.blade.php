    ...
    <div>
        <div class=" p-0 pb-4">
            <ol class="breadcrumb breadcrumb-arrow m-0 p-0" style="background: none;">
                ...
                <li class="active"><span><b>Detailed Attendance Report</b></span></li>
            </ol>
        </div>
        <!-- END ROW -->
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white" style="padding-bottom:770px;">
                <div class="container-fluid">
                    <span class="navbar-brand fw-bold me-5">
                        <span class="h3">Detailed Attendance</span>
                    </span>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                    ...
                                    <div class="dropdown-menu p-4 shadow" aria-labelledby="filterDropdown" style="min-width: 500px;">
                                        ...
                                        {{-- <form >
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <button type="button" class="btn-sm btn-outline-secondary me-2 px-4">Close</button>
                                            </div>
                                        {{-- </form> --}}
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 mt-5">
                                <form action="{{ route('musterroll.report.details') }}" method="POST" class="d-flex align-items-center">
                                    @csrf
