    ...
    <div>
        <div class=" p-0 pb-4">
            <ol class="breadcrumb breadcrumb-arrow m-0 p-0" style="background: none;">
                ...
                <li class="active"><span><b>Monthly Summary Attendance Report</b></span></li>
            </ol>
        </div>
        <!-- END ROW -->
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white" style="padding-bottom:770px;">
                <div class="container-fluid">
                    <span class="navbar-brand fw-bold me-5">
                        <span class="h3">Monthly Summary Attendance</span>
                    </span>
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <div class="col-md-3 mt-5">
                                <div class="dropdown ">
                                    ...
                                    <button class=" btn-outline-primary dropdown-toggle btn-sm" type="button" id="filterDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="col-md-6 mt-5">
                                <form action="{{ route('monthly.summary.report.details') }}" method="POST" class="d-flex align-items-center">
                                    @csrf
                                    ...
                                    <button type="submit" class=" btn-outline-success btn-sm">Export</button>
                                </form>
                            </div>
                        </ul>
...
<script>
    // Add event listeners to update hidden inputs on dropdown changes
