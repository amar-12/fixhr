...
@section('title', 'Comp Off Request Details')
            ...
            <div class="py-0 bd-highlight">
                <div>
                    <ol class="breadcrumb breadcrumb-arrow m-0 p-0" style="background: none;">
                        ...
                        <li><a href="/admin/requests/comp-off-approval">Comp Off</a></li>
                        <li class="active"><span><b>Comp Off Details</b></span></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-12 col-md-12">
                    <div class="card border overflow-hidden">
                        <div class="card-header p-3">
                            <div>
                                <h4 class="card-title">Comp Off Request</h4>
                            </div>
                        </div>
                        ...
                        <div class="card-body pt-3">
                            <div class="row">
                                ...
                                @php
                                    $value = json_decode($data->co_documents) ?? 'N/A';
                                @endphp
                        ...
                        @if ($approvalData)
                            <div class="card-header p-3">
                                <h3 class="card-title">Comp Off Approval Or Reject</h3>
                            </div>
                            <div class="card-body">
                        ...
                        @elseif ($canApprove)
                            <x-approval-form :moduleName="$data?->fh_module?->m_name" :masterApproveBtn="$masterApproveBtn" :primaryId="$data->co_id" :moduleId="$data->co_module_id"
                                actionUrl="{{ route('comp-off-approval.update', $data->co_id) }}" />
                        @endif
                    </div>
                </div>
            </div>
