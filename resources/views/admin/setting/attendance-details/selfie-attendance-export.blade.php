            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white" style="padding-bottom:770px;">
                <div class="container-fluid">
                    <span class="navbar-brand fw-bold me-5">
                        <span class="h3">Selfie Attendance</span>
                    </span>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <div class="row w-100">
                            ...
                            <div class="col-md-6 mt-5">
                                <form action="{{ route('selfie.report.details') }}" method="POST" class="d-flex align-items-center">
                                    @csrf
                                    ...
                                    <button type="submit" class="btn-sm btn-outline-success me-3">
                                        Export
                                    </button>
                                </form>
                            </div>
