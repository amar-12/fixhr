    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            datatable({
                ...
                url: "{{ route('attendance.summary-attendance') }}",
    ...
    <div>
        <div class=" p-0 pb-4">
            <ol class="breadcrumb breadcrumb-arrow m-0 p-0" style="background: none;">
                ...
                <li><a href="{{ url('/admin/attendance/summary-attendance') }}">Attendance</a></li>
                <li class="active"><span><b>Summary Attendance</b></span></li>
            </ol>
        </div>
                                ...
                                <div id="filterContainer" style="display: none; margin-bottom: 21px;" >
                                    <div class="row">
                                        <div class="col-sm-2">
                                            ...
                                            <select id="sm_branchFilter" data-filter class="form-select search-txt filter_border">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <select id="sm_departmentFilter" data-filter class="form-select search-txt filter_border">
                                                <option value="">All</option>
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <select id="sm_designationFilter" data-filter class="form-select search-txt filter_border">
                                                <option value="">All</option>
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <select id="sm_activeFilter" data-filter class="form-select search-txt filter_border">
                                                <option value="">All</option>
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <input type="month"  data-filter id="sm_monthFilter" name="monthFilter" value=" " placeholder="To Date" class="form-control filter_border" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-content tx-size-sm">
                    ...
                    <!-- <form id="bulkUploadForm" enctype="multipart/form-data"> -->
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="check_date" class="form-label">Select</label>
                                    <select id="check_date" name="check_date" class="form-select" required>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const selectBox = document.getElementById("check_date");
        const firstOption = selectBox.querySelector('option[value=""]');
        ...
        fetch(`/check-device/${empId}`)
            ...
            .then(data => {
                ...
                if (!data.installed) {
                    ...
                    Swal.fire({
                        icon: 'warning',
                        title: 'System App Required',
                        html: `
                            Please install & run system application first<br><br>
                            <b>Step 1:</b> Download EXE<br>
                            <b>Step 2:</b> Install & run once
                        `,
            ...
            .catch(() => {
                Swal.fire('Error', 'Device check failed', 'error');
            });
    });
    ...
    function uploadAttendance() {
        let formData = new FormData(document.getElementById('bulkUploadForm'));
        Swal.fire({
            title: 'Uploading...',
            allowOutsideClick: false,
            didOpen: () => Swal.showLoading()
        ...
        fetch("{{ route('monthly.attendance.import') }}", {
            method: "POST",
            headers: {
        ...
        .then(data => {
            ...
            if (!data.status) {
                ...
                if (data.type === 'system_missing') {
                    Swal.fire('Error', 'System app not running', 'error');
                    return;
                }

                if (data.type === 'location_missing') {
                    Swal.fire('Error', 'Location required', 'error');
                    return;
                }
