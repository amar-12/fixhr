...
@section('content')
    <div>
        @php
            ...
            } elseif ($slug == 'gate-pass') {
                $title = 'Gate Pass Report';

            } elseif ($slug == 'attendance-regularization') {
                $title = 'Attendance Regularization Report';

            } elseif ($slug == 'missed-punch-regularization') {
                $title = 'Missed Punch Regularization Report';
            } else {
                $title = 'Auxiliary Report';
            }
        @endphp
        <div class=" p-0 pb-4">
        ...
        @elseif ($slug == 'gate-pass')
            <div class="row pt-5">
                <div class="container-fluid bg-white" style="padding-bottom:500px;">
                    @livewire('gatepass.gatepass-report')
                </div>
            </div>
            ...
            <div class="row pt-5">
                <div class="container-fluid bg-white" style="padding-bottom:500px;">
                    @livewire('attendance-report.logs.attendance-log')
                </div>
            </div>
        ...
        @elseif ($slug == 'missed-punch-regularization')
            <div class="row pt-5">
                <div class="container-fluid bg-white" style="padding-bottom:500px;">
                    @livewire('attendance-report.logs.misspunch-log')
                </div>
            </div>
