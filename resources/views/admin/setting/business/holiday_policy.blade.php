        ...
        <div class="page-rightheader ms-auto">
            <div class="d-flex align-items-end flex-wrap my-auto end-content breadcrumb-end">
                <div class="d-lg-flex d-block ms-auto">
                    <div class="btn-list">
                        {{-- @if (in_array('Holiday Settings.Create', $permissions) || $root->hasUserPermission(['Holiday Settings.Create'])) --}}
                            <button type="button" class="btn btn-outline-primary" id="add_holiday">Create Holiday</button>
                        {{-- @endif --}}
                    </div>
                </div>
            </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table  table-vcenter text-nowrap  tabel-border-bottom " >
                    <thead>
                        <tr>
                            ...
                            <th class="border-bottom-0 text-center {{--(in_array('Holiday Settings.Delete', $permissions) || in_array('Holiday Settings.Update', $permissions) || in_array('Holiday Settings.View', $permissions) || $root->hasUserPermission(['Holiday Settings.Update','Holiday Settings.Delete','Holiday Settings.View'])) ? '' :'d-none'--}}">Action</th>
                        </tr>
                        {{-- @if ($HolidayTemplate->isEmpty()) --}}
                        <tr>
                            <td colspan="6" class="text-center"><p> No data available </p></td>
                        </tr>
                    {{-- @endif --}}
                    </thead>
                    <tbody>
                        ...
                        @foreach ($HolidayTemplate as $item) --}}
                            <tr>
                                ...
                                // $load = $root->GetPolicysCount($item->temp_id);
                                // $ll = $load[0];
                                // echo $ll;
                                ?>
                                    <span>Days</span>
                                </td>
                                <td class="font-weight-semibold"><span class="fs-11 fw-bold">W.E.F. </span><span class="with-effect-from-badge fs-10">{{--date('d-M-Y h:i A',strtotime($item->updated_at))--}}</span></td>
                                <td class="text-center">
                                    ...
                                    {{-- @foreach ($masterEndAssignCheck as $checkmaster)
                                        ...
                                        @endif
                                    @endforeach --}}
                                    {{-- @if (in_array('Holiday Settings.Update', $permissions) || $root->hasUserPermission(['Holiday Settings.Update'])) --}}
                                    ...
                                    {{-- @endif --}}
                                    {{-- @if (in_array('Holiday Settings.View', $permissions) || $root->hasUserPermission(['Holiday Settings.View'])) --}}
                                    ...
                                    {{-- @endif --}}
                                    {{-- @if (in_array('Holiday Settings.Delete', $permissions) || $root->hasUserPermission(['Holiday Settings.Delete'])) --}}
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" style="font-size:18px;">Create  Holiday Policy</h5>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" placeholder="YYYY-MM" type="month"
                                                id="temp_from" onchange="createHoliday(this)" name="temp_from" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4">
                ...
                <div class="modal-content">
                    ...
                    <form action="{{-- route('update.holiday') --}}" method="post">
                        ...
                        <div class="modal-footer d-flex justify-content-end">
                            ...
                            <button class="btn btn-outline-primary" type="sumbit" data-bs-toggle="tooltip"
            ...
            <div class="modal-content">
                ...
                <form action="{{-- route('delete.holidayTemp') --}}" method="POST">
                    ...
                    <div class="modal-body">
                        <h4 class="mt-5">Are you sure you want to delete <span id="assign_emp"></span>&nbsp;holiday ?</h4>
                    </div>
