...
@section('title', 'Dealership Settings')
@section('content')
    <div class="p-0 mt-3">
        <div class="row">
            <div class="col-md-4">
                <ol class="breadcrumb breadcrumb-arrow m-0 p-0" style="background: none;">
                    ...
                    <li class="active"><span><b>Dealership Settings</b></span></li>
                </ol>
            </div>
                    ...
                    <div class="d-flex align-items-end flex-wrap my-auto end-content breadcrumb-end">
                        <div class="d-lg-flex d-block ms-auto">
                            <div class="btn-list">
                                ...
                                data-bs-target="#createDealershipModal" data-title="Create Dealership">
                                Create Dealership
                            </x-button>
                            </div>
                        </div>
    ...
    <x-modal id="createDealershipModal" title="Create Dealership" formId="createDealershipForm"
        action="{{ route('add.dealership') }}" method="POST" enctype="multipart/form-data" size="modal-md"
        submitButtonText="Save Dealership" submitButtonId="saveSkillButton">

        {{-- <!-- Form fields --> --}}
        <x-input type="text" id="dlr_name" label="Dealership Name" name="dlr_name" placeholder="Dealership Name"
            astric="*" maxlength="200" />
        <x-input type="text" id="dlr_code" label="Dealership Code" name="dlr_code" placeholder="Dealership Code"
            astric="*" maxlength="200" />
            ...
            <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table display table-hover table-vcenter text-wrap border-bottom" id="dealership-table-dynamic">
                            <thead>
                                <tr>
    ...
    <div class="modal fade" id="dealershipBulkUpload" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-header border-0">
                    <h4 class="modal-title ms-2" id="modal-title">Upload Dealership</h4>
                    <button aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span
                            aria-hidden="true">&times;</span></button>
                </div>
                <form action="{{ route('business.dealership.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function() {
            datatable({
                tableId: "dealership-table-dynamic",
                url: "{{ route('admin.dealership') }}",
