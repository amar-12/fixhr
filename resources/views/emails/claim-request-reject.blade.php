            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>
                            I am writing to inform you that the travel expense claims submitted by {{$data['data']['claimData']->fh_employee->emp_full_name}} has been reviewed and unfortunately, it has been rejected.
                        </p>
