...
@section('content')
        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('forget.update') }}">
                        @csrf

                        <input type="text" id="emailHidden" value="{{$userId}}" name="UserId" hidden>
                        <input type="text" value="{{$Business_id}}" name="business_id"  hidden>
                        <div class="input-group mt-3 mb-2">
                            {{-- <span>OTP Sant {{$userId}}</span> --}}
    ...
    <script>
        ...
        function countDownStart() {
            ...
            $.ajax({
                url: "{{ url('login/forget-password-otp') }}",
                data: {
                    _token: '{{ csrf_token() }}',
                    email: email,
                },
