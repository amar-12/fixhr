...
<head>
    ...
    <!--favicon-->
    <link rel="shortcut icon" type="image/png" href="{{ asset('assets/logo/f_fav.ico') }}" />
    <!--bootstrap css-->
...
<body>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarContent">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-scroll-nav="8">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <!--end header-->
    <script>
        var defaultImageSrc = "{{ asset('assets/logo/logo.png') }}";
        ...
        function headerScrollHandler() {
            ...
            $('#kite').attr('src', "{{ asset('assets/logo/logo_dark.png') }}");
            // Your code here
            if (headerElement.classList.contains("two") && headerElement.classList.contains("sticky")) {
            } else {
                defaultImageSrc = "{{ asset('assets/logo/logo.png') }}";
                ...
                <div class="col-lg-7 col-md-8">
                    <div class="caption two d-table">
                        <div class="d-table-cell align-middle">
                            ...
                            <h4 class="text-dark font-open-sans">Fix HR is the most unique mobile and web based
                                software, designed
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="core-feature-single">
                        <div class="core-feature-single-item text-center">
                            ...
                            <h3>Quick Setup</h3>
                            <p align="justify">The app is really easy to install, the complete business setup process
                                will take
            ...
            <div class="row">
                ...
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2">
                    <div class="section-heading text-center">
                        ...
                        <p>We've mentioned everything you could possibly want to know about Fix HR. Some snapshots of
                            our FixHR application are: </p>
                    </div>
                </div>
                <!--end section heading-->
            </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ url('/login') }}" type="button"
                                                class="btn btn-outline-primary">Login Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!--start team area-->
    <section id="team-area" class="d-none" data-scroll-index="4">
                ...
                <div class="col-lg-5 col-md-7">
                    <div class="contact-form two">
                        <form action="{{ route('userRequest') }}" method="POST">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" id="message" name="messageInput" rows="5" placeholder="Message*"
            ...
            <div class="footer-copyright">
                <div class="row">
                    <div class="col-lg-11 col-md-11 text-center">
                        <span><span><a style="color:#1877f2" href="{{url('/privacy-policy')}}" target="blank">Privacy Policy</a></span> | <span><a style="color:#1877f2" href="{{url('/terms-and-conditions')}}" target="blank">Terms & Conditions</a></span> | <span><a style="color:#1877f2" href="{{url('/refund-policy')}}" target="blank">Refund Policy</a></span></span>
                    </div>
                    <div class="col-lg-11 col-md-11 text-center">
                        <p class="text-dark"><b>&copy; 2024 Fix HR | All right reserved | Designed by <a
                                    style="color: #1877f2; font-width:bold; font-size:16px"
                                    href="https://fixingdots.com/" target="blank">FixingDots</a>.</b></p>
                    </div>
