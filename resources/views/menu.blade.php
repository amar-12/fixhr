...
@section('content')
    ...
    <div class="p-0 mt-3">
        <ol class="breadcrumb breadcrumb-arrow m-0 p-0" style="background: none;">
            ...
            <li><a href="{{ url('/admin/settings/attendance') }}">Menu</a></li>
        ...
        <div class="page-rightheader ms-md-auto">
            <div class="d-flex align-items-end flex-wrap my-auto end-content breadcrumb-end">
                <div class="d-lg-flex d-block ms-auto">
                    <div class="btn-list">
                        <button type="button" class="btn btn-outline-primary" data-bs-target="#MenusModal" data-bs-toggle="modal" id="addMenusBtn">Add Menu</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- MODAL -->
    <div class="modal fade" id="MenusModal" tabindex="-1" role="dialog" aria-labelledby="MenusModal" aria-hidden="true" data-bs-backdrop="static">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-xl-5 mb-4">
                                <label class="form-label" for="menu_id" title="Main navigation menu selection ">Menu<span class="text-danger">*</span></label>
                                <select name="menu_id" id="menu_id" class="form-control  select2" data-placeholder="Select Menu" required>
                            ...
                            <div class="col-xl-6 mb-4">
                                <label class="form-label" for="menu_p_id" title="Submenu selection under main menu">Sub Menu<span class="text-danger">*</span></label>
                                <select name="menu_p_id" id="menu_p_id" class="form-control  select2" data-placeholder="Select Sub Menu" required>
                            ...
                            <div class="col-xl-1 mt-5">
                                <button type="button" class="btn btn-outline-primary mt-1" id="addMenutBtn"><i class="fa fa-plus"></i></button>
                            </div>
                        </div>
                        <div class="row">
                            <div id="menusRows">
                                <div class="row menus-row mb-5">
                                    ...
                                    <div class="col-md-1">
                                        <label class="form-label" for="method" title="Define the method: Create, Update, Get, Delete">Method</label>
                                        <select name="Method[]" id="Method_1" class="form-control  select2 methodType" placeholder="Select Method">
                                    ...
                                    <div class="col-md-2">
                                        <label class="form-label" for="name" title="Menu Name">Name <span class="text-danger">*</span></label>
                                        <input type="text" name="name[]" id="name_1" class="form-control" required placeholder="Name ">
                                    </div>
                                    <div class="col-md-1">
                                        <label class="form-label" for="icon" title="Menu Icon">Icon </label>
                                        <input type="text" name="icon[]" id="icon_1" class="form-control" placeholder="Icon">
                                    </div>
                                    <div class="col-md-1">
                                        <label class="form-label" for="active" title="Menu View or not">Status <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-1">
                                        <label class="form-label" for="sub_status" title="Menu Hierarchy with Nested Submenus">SubStatus</label>
                                        <input type="number" name="sub_status[]" class="form-control" min="0" placeholder="SubStatus">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label" for="route" title="Menu path which location the menu show">Route </label>
                                        <input type="text" name="route[]" class="form-control" placeholder="Route">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label" for="group" title="Which group the menu belong">Group <span class="text-danger">*</span></label>
                                        <input type="text" name="group[]" class="form-control" required placeholder="Group">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label" for="sequence" title="the position of menu like 1st,2nd,3rd like this">Sequence <span class="text-danger">*</span></label>
                                        <input type="number" name="sequence[]" class="form-control" required placeholder="Sequence" min="0">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-1">
                        <select name="Method[]" id="Method_${index}" class="form-control select2 methodType" onchange="checkForDuplicatesAndAlert()">
                            ...
                            @foreach($route_type as $route)
                                html += `<option value="{{ $route->m_id }}" ${item.menu_route_type_id == "{{ $route->m_id }}" ? 'selected' : ''}>{{ $route->m_name }}</option>`;
                            @endforeach
            html += `
                        </select>
                    </div>
                    ...
                    <div class="col-md-1">
                        <select name="active[]" id="active_${index}" class="form-control select2" required>
                            ...
                            @foreach($status as $stat)
                                html += `<option value="{{ $stat->m_description }}" ${item.menu_status == "{{ $stat->m_description }}" ? 'selected' : ''}>{{ $stat->m_name }}</option>`;
                            @endforeach
            html += `
                        </select>
                    </div>
