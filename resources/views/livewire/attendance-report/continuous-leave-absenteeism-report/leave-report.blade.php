    ...
    <div class="col-md-10">
        ...
        <div class="ef-panel">
            ...
            <div class="ef-panel-header">
                <span class="ef-panel-title">Continuous Leave Report Filters</span>
                        ...
                        @foreach ($filterFields as $key => $label)
                            @if (array_key_exists($key, $filters))
                                <div class="ef-switch-row">
                                    <label for="{{ $key }}AttSwCb">{{ $label }}</label>
            ...
            <div class="row gx-3 gy-3 ef-fields-grid {{ $showFilterPanel ? 'ef-grid-shrink' : '' }}">
                ...
                <x-search-input label="Leave Type" wireModel="searchLeaveType" :results="$leaveTypes"
                    selectMethod="selectLeaveType" idField="m_id" nameField="m_name"
                    errorField="selectedLeaveTypeId" mainCol="col-md-6" />
                {{-- Leave Segment --}}
