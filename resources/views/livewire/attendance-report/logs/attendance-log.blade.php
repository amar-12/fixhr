    ...
    <div class="col-md-10">
        ...
        <div class="ef-panel">
            ...
            <div class="ef-panel-header">
                <span class="ef-panel-title">Attendance Regularization Report Filters</span>
            ...
            <div class="row gx-3 gy-3 ef-fields-grid {{ $showFilterPanel ? 'ef-grid-shrink' : '' }}">
                ...
                @endif
                @if ($filters['checkingMethod'] ?? false)
