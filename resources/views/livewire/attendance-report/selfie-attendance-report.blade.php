        ...
        <div id="resumeBanner" class="ef-resume-banner" onclick="showReportPopup()">
            <div class="d-flex align-items-center justify-content-between gap-3">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        <div style="font-weight:600; font-size:13px;">Selfie Report in Progress</div>
        ...
        @if (!$generatingReport)
            <div class="ef-panel">
                ...
                <div class="ef-panel-header">
                    <span class="ef-panel-title">Selfie Attendance Report Filters</span>
                            ...
                            @foreach ($filterFields as $key => $label)
                                @if (array_key_exists($key, $filters))
                                    <div class="ef-switch-row">
                                        <label for="{{ $key }}SaSwCb">{{ $label }}</label>
                ...
                <div class="row gx-3 gy-3 ef-fields-grid {{ $showFilterPanel ? 'ef-grid-shrink' : '' }}">
                    ...
                    {{-- Conditional: Log Direction --}}
                    @if ($filters['punchingMode'])
                        <div class="col-md-6">
                            <label class="ef-field-label">Log Direction</label>
                            <div class="ef-input-wrap">
                                <select wire:model.live="punchingMode" class="ef-control">
    ...
    <script>
        ...
        document.addEventListener('livewire:initialized', () => {
            ...
            Livewire.hook('component.initialized', (component) => {
                if (component.name === 'attendance-report.selfie-attendance-report') {
