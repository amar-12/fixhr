<div>
    @if($showButton)
        <div class="glass-card hover-effect" style="padding: 16px; flex: 1 1 calc(25% - 16px); min-width: 200px;">
            <div
                style="width: 36px; height: 36px; border-radius: 8px; background: #fef3c7; display: flex; align-items: center; justify-content: center; color: #d97706; margin-bottom: 12px;">
                <i data-lucide="landmark" style="width: 18px; height: 18px;"></i>
            </div>
            <h3 class="head-text" style="font-size: 0.85rem; margin-bottom: 6px; font-weight: 600;">Bank Letter</h3>
            <p class="para-text" style="font-size: 0.7rem; color: #64748b; margin-bottom: 10px; line-height: 1.3;">
                Bank_Letter_Head.xlsx
            </p>
             <!-- Round Off Checkbox -->
    <label for="roundOff"
        ...
        Round Off All Values
            ...
            <button type="button"
                wire:click="generateLetterHead"
                wire:loading.attr="disabled"
                wire:target="generateLetterHead"
                ...
                <span wire:loading.remove.inline-flex wire:target="generateLetterHead" style="align-items: center; gap: 4px;">
                    <i data-lucide="download" style="width: 10px; height: 10px;"></i>
                    Download
                </span>
                <span wire:loading.inline-flex wire:target="generateLetterHead" style="align-items: center; gap: 6px; cursor: wait; color: #334155;">
