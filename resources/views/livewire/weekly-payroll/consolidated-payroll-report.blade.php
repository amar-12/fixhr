 <!-- Consolidated Report -->
        <div class="glass-card hover-effect" style="padding: 16px; flex: 1 1 calc(25% - 16px); min-width: 200px;">
            <div
                style="width: 36px; height: 36px; border-radius: 8px; background: #fee2e2; display: flex; align-items: center; justify-content: center; color: #dc2626; margin-bottom: 12px;">
               <i data-lucide="activity" style="width:18px;height:18px;"></i>

            </div>
            <h3 class="head-text" style="font-size: 0.85rem; margin-bottom: 6px; font-weight: 600;">Consolidated Report</h3>
            ...
            <button type="button"
                ...
                <span wire:loading.remove.inline-flex wire:target="generateCombinedReport" style="align-items: center; gap: 4px;">
                    <i data-lucide="download" style="width: 10px; height: 10px;"></i>
                    Download
                </span>
                <span wire:loading.inline-flex wire:target="generateCombinedReport" style="align-items: center; gap: 6px; cursor: wait; color: #334155;">
