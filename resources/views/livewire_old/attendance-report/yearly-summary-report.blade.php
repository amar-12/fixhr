            ...
            <div class="col-md-5">
                <div class="row gx-3">
                    ...
                    <x-search-input label="Employee/Code"   wireModel="search" :results="$employees"
                        ...
                        errorField="selectedEmployeeId" mainCol="col-md-12" />
                    <div class="col-md-12">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    <select class="form-select shadow-sm report" wire:model="selectedYear"
                                        wire:change="selectYear($event.target.value)" style="font-size: 12px; height: 30px;">
            ...
            <div class="row mt-2">
                <div class="col-5 d-flex justify-content-end px-0">
                    ...
                    Swal.fire({
                        position: 'top-end',
                        icon: 'info',
                        title: 'This may take some time depending on the data size. Please wait...',
                        toast: true,
