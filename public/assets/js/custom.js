  ...
  function index1(myVarVal, attendanceData) {
    "use strict";
    /*----- Attendance ------*/
  ...
  function hexToRgba(hexValue, alpha) {
    ...
    function names() {
      ...
      if (document.querySelector('#attendance') !== null) {
        (0,_index__WEBPACK_IMPORTED_MODULE_0__.index1)(myVarVal, attendanceData);
        console.log("myvarVal"+myVarVal);
      }
...
//     // Clear all text inputs and date fields
//     document.querySelectorAll('input[type="text"], input[type="date"], input[data-search]').forEach(input => {
//         input.value = '';
//     });
