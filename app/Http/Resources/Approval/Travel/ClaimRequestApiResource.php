...
class ClaimRequestApiResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'tc_plan_details' => TravelRequestApiResource::collection([$this->fh_tada_request_plan])->all(),
