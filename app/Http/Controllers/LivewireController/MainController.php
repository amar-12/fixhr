...
class MainController extends Controller
{
    public function employeeReport($slug = null)
    {
        ...
        if (!in_array($slug, ['employee-detail', 'employee-birthday', 'employee-joining', 'approver-matrix'])) {
            return
                abort(404);
        }
    ...
    {
        if (!in_array($slug, ['summery', 'deatails', 'balance', 'daily-forecast', 'department-wise-forecast'])) {
            abort(404);
        }
