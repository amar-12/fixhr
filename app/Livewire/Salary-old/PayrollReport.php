...
class PayrollReport extends Component
{
    ...
    //     // Remaining personal & banking columns
    //     $personalBankingColumns = [
    //         'Date of Joining',
    ...
    //             'Project' => (function () use ($item, $projectNames) {
    ...
    //             })(),
    //             'Region'                    => $item->employee->fh_emp_region?->m_name ?? $item->employee->emp_region_id ?? '',
    //         ];
    ...
    //             $this->personalBankingColumns = $personalBankingColumns;
    ...
    //             // Only add employee contacts header if enabled
    //             if ($this->employeeContactsHeading) {
    ...
    //             // Personal & Banking columns (no specific header)
    //             for ($i = 0; $i < count($this->personalBankingColumns); $i++) {
    //                 $groupRow[] = '';
    //             }
    ...
    //                 + count($this->personalBankingColumns);
    ...
    //                     $bankingEnd = $currentCol + count($this->personalBankingColumns) - 1;
    //                     // Note: Personal Banking doesn't get a section header, so no merge
    //                     $currentCol = $bankingEnd + 1;
    ...
    //                         'Employee Contacts: Personal & official contact details',
    ...
    //     // Employee Contacts Group - NOW INCLUDES Project and Region
    //     $employeeContactsColumns = [
    //         'Project',
    //         'Region',
    //         'Personal Mobile',
    ...
    //         // Employee Contacts (conditional) - NOW INCLUDES Project and Region
    //         if ($this->selectedEmployeeContactsHeading) {
    ...
    //             // Only add employee contacts if heading is enabled - NOW INCLUDES Project and Region
    //             if ($this->employeeContactsHeading) {
    //                 $headers = array_merge($headers, $this->employeeContactsColumns);
    //             }
    ...
    //             // Only add employee contacts header if enabled - NOW INCLUDES Project and Region
    //             if ($this->employeeContactsHeading) {
    //                 $groupRow[] = $this->employeeContactsHeading;
    //                 for ($i = 1; $i < count($this->employeeContactsColumns); $i++) {
    //                     $groupRow[] = '';
    ...
    //                 if ($header === 'S#' || $header === 'Emp Code') {
    //                     $widths[$colLetter] = 7;
    //                 } elseif ($header === 'Project' || $header === 'Employee Name') {
    //                     $widths[$colLetter] = 20; // Wider for project names and employee names
    //                 } else {
    //                     $widths[$colLetter] = 13;
    //                 }
    //             }
    ...
    //                     // Basic Info Section (now without Project and Region)
    //                     $basicEnd = count($this->basicInfoColumns);
    //                     $sections[] = ['start' => $currentCol, 'end' => $basicEnd];
    //                     $currentCol = $basicEnd + 1;

    //                     // Employee Contacts Section (conditional) - NOW INCLUDES Project and Region
    //                     if ($this->employeeContactsHeading) {
    //                         $contactsEnd = $currentCol + count($this->employeeContactsColumns) - 1;
    //                         $sections[] = ['start' => $currentCol, 'end' => $contactsEnd];
    //                         $currentCol = $contactsEnd + 1;
    ...
    //                     $notes = [
    //                         'Employee Details: Basic information about the employee',
    //                         'Employee Contacts: Project, Region, Personal & official contact details', // Updated note
    //                         'Salary Master: Fixed components defined in employee salary structure',
    //                         'Attendance Summary: Key attendance metrics for the payroll period',
    //                         'Earnings: Variable or processed earnings calculated and paid this month',
    //                         'Deductions: Variable or processed deductions applied this month',
