...
use App\Exports\Loan\LoanStatements as LS;
...
class LoanStatements extends Component
{
    // public $slug;
    ...
    public function generateReport()
    {
        ...
        return Excel::download(new LS($result,$this->businessId, $this->selectedMonth), 'loan_register_' . date('d_m_Y_H_i_s') . '.xlsx');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.loan.loan-statements', compact(
            'employees',
            'employeeStatus',
            'approvalStatus'
