...
class DailyAttendanceDetailReport extends Component
{
    ...
    public function generateReport()
    {
        $this->validate([
            ...
            'selectedAttendanceStatusId' => 'nullable', // or validate with master table if dynamic
        ...
        return Excel::download(new DailyAttendanceReport($records, $this->filters), 'DailyAttendanceReport.xlsx');
    }
