...
class AdhocReport extends Component
{
    ...
    public function generateReport()
    {
        ...
        $query = AdhocTransaction::with([
            'employee' => fn($q) => $q->select('emp_id', 'emp_code', 'emp_full_name'),
    ...
    public function render()
    {
        ...
        $departments = Department::where('d_b_id', $this->businessId)
            ...
            ->limit(100)
            ->get();
        return view('livewire.salary.adhoc-report', compact('financialYears', 'payrollPeriods', 'employees', 'departments'));
    }
}
